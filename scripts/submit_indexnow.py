...
DEFAULT_HOST = "urbanfresh.in"
DEFAULT_KEY = "c9bfacff25ef7a96c1817a046e3a2639"
...
def fetch_live_key(key_location: str) -> str:
    ...
    request = urllib.request.Request(
        cache_busted,
        headers={"User-Agent": "UrbanFresh-IndexNow-Submitter/1.0"},
    )
    try:
...
def submit_urls(
    ...
    request = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "UrbanFresh-IndexNow-Submitter/1.0",
        },
        method="POST",
    )
    try:
