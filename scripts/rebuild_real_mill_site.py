...
def header(active: str = "") -> str:
    ...
    return dedent(f"""
      ...
      <div class="topbar"><div class="container topbar-inner"><span><strong>Fully automated production facility</strong> · Village Daha, Madanpur, Karnal</span><div class="topbar-list"><a href="tel:{PHONE_LINK}">{PHONE}</a><span>India and export enquiries welcome</span></div></div></div>
...
def footer(contact_page: bool = False) -> str:
    ...
    return dedent(f"""
      <footer class="site-footer"><div class="container footer-grid">
        <div class="footer-brand"><a class="brand" href="/"><img class="brand-mark" src="assets/images/urbanfresh-logo.webp" width="50" height="50" alt=""><span class="brand-copy"><span class="brand-name">UrbanFresh</span><span class="brand-tag">Rice Mills · Karnal</span></span></a><p>A family-operated rice mill established in 1978, serving bulk buyers from Village Daha Madanpur, Karnal. {AUTOMATION_CLAIM}</p></div>
